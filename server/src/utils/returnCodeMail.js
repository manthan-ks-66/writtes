...
<head>
  ...
  <style>
      .bg-page { background-color: #13273b !important; }
      .card { background-color: #171d2f !important; }
    ...
    <tr>
      <td align="center">
        ...
        <table width="100%" class="card" style="max-width: 560px; background-color: #ffffff; border-radius: 20px; overflow: hidden; box-shadow: 0 8px 40px rgba(85, 170, 0, 0.12);" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="center" style="padding: 40px 40px 12px 40px;">
              <img src="https://ik.imagekit.io/mksiz1z5tvi7/Logo/FullLogo_NoBuffer.png" alt="Logo" width="110" style="display: block; border: 0;">
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding: 0 40px 32px 40px;">
              <p style="font-family: 'Noto Sans', 'PingFang SC', 'Alibaba PuHuiTi', sans-serif; font-size: 13px; font-weight: 700; letter-spacing: 4px; text-transform: uppercase; color: #55aa00; margin: 0;">ONE TIME PASSCODE</p>
            </td>
          </tr>
          ...
          <tr>
            <td class="body-text" style="padding: 36px 40px 12px 40px; text-align: center; color: #1f2937;">
              ...
              <p class="sub-text" style="font-size: 15px; line-height: 26px; color: #4b5563; margin: 0 0 32px 0; font-weight: 400;">
                To continue with the <span>${processMsg}</span> on WRITTES,<br>
                Use the OTP given below.
              </p>
          ...
          <tr>
            <td style="padding: 24px 40px 32px 40px; text-align: center;">
              ...
              <p style="font-family: 'Noto Sans', 'PingFang SC', 'Alibaba PuHuiTi', sans-serif; font-size: 18px; font-weight: 700; color: #55aa00; margin: 0;">The WRITTES Team</p>
            </td>
          </tr>
        ...
        <p class="footer-muted" style="font-size: 12px; color: #94a3b8; margin-top: 24px; text-align: center; letter-spacing: 0.5px; font-weight: 400;">
          &copy; 2026 WRITTES. All rights reserved.
        </p>
